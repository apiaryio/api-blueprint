...
+ Request A query limited to one result

    We have added the parameters that will be sent as a part of this request below. The response paired with this request returns only 1 message since we set the parameter `limit` value to 1.
